                    ...
                    <div class="card-section">
                        <div class="grid-x align-center">
                            <div class="small-10 cell">
                                <form enctype="multipart/form-data" data-abide novalidate  method="POST" action="{{ route('posts.update', $post->id) }}">
                                @csrf
                                @method('PATCH')
                                <div class="title">
                                    <label class="font-bold" for="title">Post Title</label>
                                    <input class="radius" id="title" type="text" name="title" value="{{ $post->title }}" aria-errormessage="titleError" aria-describedby="titleHelpText" required autofocus>
                                ...
                                <div class="message">
                                    ...
                                    <textarea id="message" name="message" aria-describedby="messHelpText" rows="3" class="radius" aria-errormessage="messError" required>{{ $post->message }}</textarea>
                                ...
                                <button type="submit" class="button radius">Update Post</button>
